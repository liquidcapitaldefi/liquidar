  ...
  */}
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                ...
                <a href='https://twitter.com/lqd_capital'rel="noopener noreferrer" target="_blank" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out">
              ...
              <li className="ml-4">
                  ...
                  <a href='https://discord.gg/vR9eJjPAF9'rel="noopener noreferrer" target="_blank" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out">
