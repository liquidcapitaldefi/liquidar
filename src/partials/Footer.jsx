...
function Footer() {
  ...
  */}
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                <Link to="https://twitter.com/lqd_capital" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Twitter">
              ...
              <li className="ml-4">
                <Link to="https://discord.gg/vR9eJjPAF9" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Discord">
