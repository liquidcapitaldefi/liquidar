...
function Header() {
  ...
  */}
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link to="/" className="btn-sm text-black bg-purple-600 hover:bg-purple-700 ml-3">Wen Dapp?</Link>
              </li>
            </ul>
          ...
          <div className="md:hidden">
            ...
            {/*Mobile navigation      <li>
                ...
                <li>
                  <Link to="/" className="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2 rounded-sm text-black bg-purple-600 hover:bg-purple-700 transition duration-150 ease-in-out">Wen Dapp?</Link>
                </li>
              </ul>
            </nav>
